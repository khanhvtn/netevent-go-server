...
func (u *EventTypeService) createContextAndTargetCol(colName string) (col *mongo.Collection,
	ctx context.Context,
...
func (u *EventTypeService) GetAll() ([]*models.EventType, error) {
	//get a collection , context, cancel func
	collection, ctx, cancel := u.createContextAndTargetCol("eventTypes")
	defer cancel()
