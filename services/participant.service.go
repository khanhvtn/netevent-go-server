...
func (u *ParticipantService) createContextAndTargetCol(colName string) (col *mongo.Collection,
	ctx context.Context,
...
func (u *ParticipantService) GetAll() ([]*models.Participant, error) {
	//get a collection , context, cancel func
	collection, ctx, cancel := u.createContextAndTargetCol("participants")
	defer cancel()
