...
func (u *FacilityHistoryService) createContextAndTargetCol(colName string) (col *mongo.Collection,
	ctx context.Context,
...
func (u *FacilityHistoryService) GetAll(condition *bson.M) ([]*models.FacilityHistory, error) {
	...
	collection, ctx, cancel := u.createContextAndTargetCol("facilityHistories")
	defer cancel()
